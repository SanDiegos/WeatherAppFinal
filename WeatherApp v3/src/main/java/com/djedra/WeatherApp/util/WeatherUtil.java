...
import com.djedra.WeatherApp.api.WeatherExterenalAPIResponseConstrains.ConsolidatedWeatherResponseKeys;
...
public class WeatherUtil {
	...
	private static LocalTime createLocalTime(String dateWithTime) {
		...
		return LocalTime.of(Integer.parseInt(hourMinuteSecond[0]), Integer.parseInt(hourMinuteSecond[1]),
